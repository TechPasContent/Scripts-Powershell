...
if ($bInstallDNS -ieq "false") { $bInstallDNS = $false} else { $bInstallDNS = $true }
$bInstallDHCP = (Get-Content .\general.conf)[16].Split()[2]
if ($bInstallDHCP -ieq "false") { $bInstallDHCP = $false} else { $bInstallDHCP = $true }
$bInstallAD = (Get-Content .\general.conf)[17].Split()[2]
if ($bInstallAD -ieq "false") { $bInstallAD = $false} else { $bInstallAD = $true }
$bInstallForest = (Get-Content .\general.conf)[18].Split()[2]
if ($bInstallForest -ieq "false") { $bInstallForest = $false} else { $bInstallForest = $true }
